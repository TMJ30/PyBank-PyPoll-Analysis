# Python - Reading CSVs
Created a python script to analyze financial records of a sample company using the financial dataset provided in [budget_data.csv](PyBank/Resources/budget_data.csv)
